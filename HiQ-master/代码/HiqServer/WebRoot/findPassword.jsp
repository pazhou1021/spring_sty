...
<html>
  ...
  <style type="text/css">
   ...
   --> 
	...
	function scroll(){
		...
		if(mi<10)hr="0"+mi;
		if(sec<10)sec="0"+sec;
		var clocktext="HiQ 找回密码 NOW:"+hr+":"+mi+":"+sec;
  ...
  <table width="70%" height="20" border="0" bgcolor="" align="center">
     <tr><td align="center"><font family="微软雅黑" size="5"><b> HiQ 找回密码 </b></font></td></tr>
   </table>
 			...
 			<table  cellspacing="0" cellpadding="" width="525" height="525"  border="5"  bgColor="#1cf9ee"  align="center">
    			...
    			<tr>
    				<td background="images/whit.jpg">
    					<form action="findPasswordServlet" method="post" id="register" onreset="return Reset()"  onsubmit="return check()" >	
    					<font color=""  size="4" face="微软雅黑"> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;请按照您之前申请时填写的信息填写以下信息</font><br/><p>
    	
    				<center><font color=""  size="3" face="微软雅黑">HiQ&nbsp;&nbsp;&nbsp;号:</font>&nbsp;&nbsp;
    				<input style="background-color:#BFEEFF" type="text" name="userQQ" id="userQQ"  width="100" size="25"  onblur="name('userNikName')"><br><p>
