...
public class User implements Serializable{
	...
	public String toString() {
		...
		String state ="";
		if (userState == 0) state = "在线";
		else if (userState == 1) state = "隐身";
		else if (userState == 2) state = "离开";
		else if (userState == 3) state = "勿扰";
		else if (userState == 4) state = "离线";

		return String.format("%-20s%20s", this.userNikName, "用户状态:" + state);
	}
