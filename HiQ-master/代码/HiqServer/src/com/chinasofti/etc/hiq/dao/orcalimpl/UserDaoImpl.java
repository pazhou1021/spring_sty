...
public class UserDaoImpl extends BaseDaoImpl implements UserDao {
	...
	public int insertUser(User user) {
		...
		doOperate(sql, maxId + 1,user.getUserQQ(),user.getUserPassword(),user.getUserImage(),user.getUserNikName(),
	...
	public int upateUserByUserId(int userId, User newUser) {
		...
		getConn();
		String sql = "update Users set userId = ?,userQQ = ?,userPassword=?,userImage=?,userNikName=?,userSex=?,userAddress=?,userAge=?,userBirthday=?,userEmail=?,userRgDate=?,userSpeak=? where userId = ?";
		doOperate(sql, newUser.getUserId(),newUser.getUserQQ(),newUser.getUserPassword(),newUser.getUserImage(),newUser.getUserNikName(),
	...
	public int updateUserByUserQQ(int userQQ, User newUser) {
		// TODO Auto-generated method stub
		getConn();
		String sql = "update Users set userId = ?,userQQ = ?,userPassword=?,userImage=?,userNikName=?,userSex=?,userAddress=?,userAge=?,userBirthday=?,userEmail=?,userRgDate=?,userSpeak=? where userQQ = ?";
		doOperate(sql, newUser.getUserId(),newUser.getUserQQ(),newUser.getUserPassword(),newUser.getUserImage(),newUser.getUserNikName(),
				newUser.getUserSex(),newUser.getUserAddress(),newUser.getUserAge(),newUser.getUserBirthday(),newUser.getUserEmail(),
	...
	public int updateUserByNikName(String userNikName, User newUser) {
		// TODO Auto-generated method stub
		getConn();
		String sql = "update Users set userId = ?,userQQ = ?,userPassword=?,userImage=?,userNikName=?,userSex=?,userAddress=?,userAge=?,userBirthday=?,userEmail=?,userRgDate=?,userSpeak=? where userNikName = ?";
		doOperate(sql, newUser.getUserId(),newUser.getUserQQ(),newUser.getUserPassword(),newUser.getUserImage(),newUser.getUserNikName(),
				newUser.getUserSex(),newUser.getUserAddress(),newUser.getUserAge(),newUser.getUserBirthday(),newUser.getUserEmail(),
